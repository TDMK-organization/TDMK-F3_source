...
namespace Export_FPCA_OK2ship_Auto_System.Services
{
    public class BarCodeVertification
    {
        ...
        {
            string json = TDMK_ConverterService.DataTableToJson(dataTable);
        ...
        public void Export(SqlConnection sql, ExcelWorksheet workSheet, string itemCode, string lotNo)
        {
            ...
            DBContext db = new DBContext(sql);
        ...
        private string[] JudgeSN(string SN, IList<string> code)
        {
            ...
            foreach (var item in code)
            {
                ...
                if (TDMK_ValidateService.isDigitAndChar(sub))
                {
                    res.Add(sub);
                }
                startS += length;
        ...
        public DataTable LoadProcess(string itemCode, string lotNo)
        {
            ...
            DataTable dz = TDMK_ConverterService.JsonToDataTable(dt.Rows[0]["ListSN"].ToString());

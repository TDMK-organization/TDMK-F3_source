    ...
    class DataGridViewProgressCell : DataGridViewImageCell
    {
            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            if (percentage >= 0.0)
            {
                ...
                g.FillRectangle(new SolidBrush(Color.FromArgb(203, 235, 108)), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width*0.95)), cellBounds.Height / 1 - 5);
                //Draw text

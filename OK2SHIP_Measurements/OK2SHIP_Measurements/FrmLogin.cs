...
namespace OK2SHIP_Measurements
{
    public partial class FrmLogin : Form
    {
        ...
        {
            bool login_en = false;
            DataTable dataTable = TDMK_Helpers.GetDataTableWithCaChe(OK2SHIP_Measurements.sqlcon_OK2SHIP, $"User_ID='{txtUserID.Text}' and User_Password='{txtPass.Text}'", "UserInfo");
            if (dataTable.Rows.Count > 0)
            {
                ...
                //{
                //    Button btnLogin = (Button)fc.Ctrl(SEI_Lib.FAI_form, "btnLogin");
                //    btnLogin.Text = "Logout";
                //    NumericUpDown numQty = (NumericUpDown)fc_numQty.Ctrl(SEI_Lib.FAI_form, "numQty");
                //    numQty.Enabled = true;
                //    GroupBox GBControl = (GroupBox)fc_GBControl.Ctrl(SEI_Lib.FAI_form, "GBControl");
                //    GBControl.Enabled = true;
                //    btnLogin.BackColor = Color.Green;
                //}
                //if(SEI_Lib.IPQC_Man_form!=null)
                //{
                //    NumericUpDown numQty = (NumericUpDown)fc.Ctrl(SEI_Lib.IPQC_Man_form, "numQty");
                //    numQty.Enabled = true;
                //}
                //Dispose();
                login_en = true;

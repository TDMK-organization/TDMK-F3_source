...
{
    public partial class FAI_Chart : Form
    {
        public SEI_Lib.FAI_Spec FAI_Spec_val { get; set; }
        ...
        public SEI_Lib.Calculate_CPK src_CPK_result { get; set; }
        ...
        public void Draw_Histogram(ZedGraph.ZedGraphControl tar_Graph, double[] src_bin, int[] src_freq_bin, double[] src_modified, SEI_Lib.FAI_Spec src_FAI_spec)
        {
        ...
        public void Draw_Chart(ZedGraph.ZedGraphControl tar_Graph, double[] src_FAI, SEI_Lib.FAI_Spec src_FAI_spec)
        {
        ...
        public void Display_Result(SEI_Lib.Calculate_CPK src_CPK_result, SEI_Lib.FAI_Spec src_FAI_spec)
        {
            ...
            //txtUL.Text = src_FAI_spec.UL;
            //txtLL.Text = src_FAI_spec.LL;
            ...
            //txtCP.Text = src_CPK_result.CP.ToString();
            //txtCPKL.Text = src_CPK_result.CPKL.ToString();
            //txtCPKU.Text = src_CPK_result.CPKU.ToString();
            //txtCPK.Text = src_CPK_result.CPK.ToString();
            ...
            if (myCode.IsNumeric(src_FAI_spec.UL))
            {
                double USL = Convert.ToDouble(src_FAI_spec.SetVal) + Convert.ToDouble(src_FAI_spec.UL);
            ...
            if (myCode.IsNumeric(src_FAI_spec.LL))
            {
                double LSL = Convert.ToDouble(src_FAI_spec.SetVal) - Convert.ToDouble(src_FAI_spec.LL);
            ...
            txtCPKM.Text = src_CPK_result.CPKM.ToString("0.00#");
            this.Text = src_FAI_spec.FAI_Name + "_Histogram";
            tabChart.TabPages[0].Text = src_FAI_spec.FAI_Name + "_Histogram";
            tabChart.TabPages[1].Text = src_FAI_spec.FAI_Name + "_Calculate CPK";
        ...
        private void FAI_Chart_Load(object sender, EventArgs e)
        {

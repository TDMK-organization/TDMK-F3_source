...
namespace OK2SHIP
{
    public partial class Electrical_Details : Form
    {
        ...
        DataTable _spec_dt;
        public Electrical_Details()
        {
            InitializeComponent();
        }
        public Electrical_Details(DataTable _src_data, string _ItemCode, string _process_name, SqlConnection _sqlcon)
        {
            InitializeComponent();
            src_data = _src_data;
            ItemCode = _ItemCode;
        ...
        {            
            ...
            string USL = _spec_dt.Rows[r_inx][3].ToString();
            string LSL = _spec_dt.Rows[r_inx][2].ToString();
